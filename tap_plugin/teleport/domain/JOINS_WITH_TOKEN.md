...
An agent, a separately-run proxy or a Machine ID bot joined (or joins) the cluster by presenting this provision token.
...
- **Source:** `teleport__teleport_agent`, `teleport__teleport_proxy_server`, `teleport__teleport_bot`
- **Target:** `teleport__teleport_join_token`
