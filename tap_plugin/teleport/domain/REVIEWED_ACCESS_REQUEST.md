# REVIEWED_ACCESS_REQUEST

## Blurb

A user reviewed an access request.
...
- **Target:** `teleport__teleport_access_request`
- **Dimensions:** `teleport.plane: policy`

Properties:

- `proposal` — The reviewer's decision.
- `reviewed_at` — When the review was submitted (ISO-8601).
