...
An agent's SSH, Kubernetes, Database, Application or Windows Desktop service serves this protected resource: it heartbeats the resource into the cluster and carries its sessions.
...
- **Source:** `teleport__teleport_agent`
