# UPLOADS_SESSION_RECORDINGS

## Blurb

An auth server uploads completed session recordings to durable storage (agents and proxies stream through it). Target open: an S3 bucket, GCS, Azure Blob or a file directory.
