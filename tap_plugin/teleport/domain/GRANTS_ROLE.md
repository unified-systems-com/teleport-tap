...
An access list grants a role to its members (spec.grants.roles); owners' grants carry `audience: owner`.
...
- **Source:** `teleport__teleport_access_list`
- **Target:** `teleport__teleport_role`
- **Dimensions:** `teleport.plane: policy`

Properties:

- `audience` — Whether members or owners receive the role.
