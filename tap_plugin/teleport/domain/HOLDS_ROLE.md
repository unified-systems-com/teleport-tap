...
A user or bot holds a role, and how: assigned statically, mapped at SSO login, granted by an access-list membership, or assumed through an approved access request.
...
- **Source:** `teleport__teleport_user`, `teleport__teleport_bot`
- **Target:** `teleport__teleport_role`
- **Dimensions:** `teleport.plane: policy`

Properties:

- `granted_by` — Where the role came from — the question an access review asks.
